...
{
#ifdef _WIN32
    base = (uint8_t*)VirtualAlloc((void*)Memory::BASE_ADDRESS, PPC_MEMORY_SIZE, MEM_COMMIT | MEM_RESERVE, PAGE_READWRITE);
...
#else
    base = (uint8_t*)mmap((void*)Memory::BASE_ADDRESS, PPC_MEMORY_SIZE, PROT_READ | PROT_WRITE, MAP_ANON | MAP_PRIVATE, -1, 0);
